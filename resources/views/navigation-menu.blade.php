...
$nav_links = [
    ...
    [
        'name' => 'Estudios',
        'route' => route('studies.index'),
        'active' => request()->routeIs('studies.index'),
    ],
    [
        'name' => 'Actividades',
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow">
    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-28">
            <div class="flex ">
                <!-- Logo -->
                <div class="flex-shrink-0 flex items-center align-items">
                    <a href="{{ route('welcome') }}">
                        <x-jet-application-mark class="w-auto h-auto" />
                    </a>
                </div>
