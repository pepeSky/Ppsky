<x-welcome-layout>
    ...
    <div class="py-12">
        <section class="bg-cover" style="background-image: url({{ asset('img/dashboard/banner-principal.jpeg') }})">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36">
                <div class="w-full md:w-3/4 lg:w-1/2">
                    <h1 class="pt-6 text-black font-bold text-4xl">Modulos</h1>
                    <p class="pt-6 text-black text-lg mt-2">Modulos de Gestion para el desarrollo de tus metas y
                        objetivos.</p>
                    ...
                    <div class="pt-2 relative mx-auto text-gray-600">
                        ...
                        <button type="submit"
                            class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded absolute right-0 top-0 mt-2">
                            Search
                        </button>
        ...
        <section class="mt-24 my-24">
            <h1 class="text-center text-3xl text-gray-600 ">Desarrollando Realidades</h1>
